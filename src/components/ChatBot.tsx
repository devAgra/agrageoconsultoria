  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-24 right-6 z-[9999] w-14 h-14 bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 transition-all flex items-center justify-center ${
          isOpen ? "hidden" : ""
        }`}
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-[9999] w-[360px] max-w-[calc(100vw-2rem)] h-[500px] max-h-[calc(100vh-6rem)] bg-primary border-2 border-secondary shadow-elevated flex flex-col overflow-hidden">
          {/* Header */}
