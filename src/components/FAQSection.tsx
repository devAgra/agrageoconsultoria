...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "O geoprocessamento envolve a coleta, processamento e análise de dados geográficos para tomada de decisão. Elaboramos mapas temáticos, análises espaciais, modelagem de terreno, estudos de uso e ocupação do solo, e integramos dados de diferentes fontes. Essas informações são fundamentais para estudos ambientais, planejamento territorial e gestão de propriedades.",
  },
];
